    	...
    	platform.ready().then(() => {
			...
			if(platform.is('android')) {
				this._admobid = { // for Android
					banner: 'ca-app-pub-2795833774364245/4361378817 ',
					interstitial: 'ca-app-pub-2795833774364245/7594046817'
				};
			}

		   	if(platform.is('ios')){
		    	this._admobid = { // for iOS
					banner: 'ca-app-pub-2795833774364245/2884645614',
					interstitial: 'ca-app-pub-2795833774364245/2745044816 '
		    	};
		   	}      
	      	this.init();
	    });
